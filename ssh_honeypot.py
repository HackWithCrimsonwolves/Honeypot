...
# Run this command in ubuntu terminal for the connection of the ssh honeypot just go to honey.py file
# and click play(run) button then on ubuntu terminal just write this command
