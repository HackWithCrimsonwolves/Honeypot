...
# This command is only for running the wordpress page in the browser but when you want to deploy it you
# have to remove this line as i have add this line code in the honey.py file so i can deploy this on vps 
# so that you can see the connections on the ubuntu terminal..
